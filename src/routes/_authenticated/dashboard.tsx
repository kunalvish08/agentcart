...
function DashboardPage() {
  ...
  return (
    <AppShell
      ...
      subtitle="'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            Add a unified premium motion system across the entire Agentic Commerce website.\n\nDo not change any backend, API, database, payment, evaluation or business logic.\n\nUse Framer Motion for purposeful UI motion.\n\nCore motion language:\n\n- AI/API/server data flows\n\n- sequential state transitions\n\n- subtle animated connectors\n\n- number count-ups\n\n- smooth hover micro-interactions\n\n- progressive reveal\n\n- status transitions\n\n- expandable technical details\n\nLanding:\n\nAnimate AI Buyer → API → Server Authority → Razorpay flow.\n\nDashboard:\n\nAnimate KPI count-ups, commerce pipeline and policy enforcement.\n\nAI Buyer:\n\nAnimate agent reasoning states and tool-call progression.\n\nExternal AI Buyer:\n\nAnimate HTTP request → server response journey and live execution trace.\n\nPolicies:\n\nVisually animate AI request → policy evaluation → allowed/counter/rejected.\n\nApprovals:\n\nAnimate Requested → Approved/Rejected → Payment → Completed.\n\nEvaluation Lab:\n\nAnimate experiment progress, metrics and comparison results.\n\nJudge Mode:\n\nCreate the strongest motion experience:\n\nDiscovery → Search → Quote → Negotiation → Policy → Checkout →\n\nApproval → Razorpay → Verification → Completed.\n\nReveal the authority responsible at each step.\n\nAgent API:\n\nAnimate request/response panels and endpoint execution.\n\nUse restrained, premium motion.\n\nNo bouncing, flashy particles, excessive parallax, neon effects or decorative animation.\n\nAnimation must explain system behavior and hierarchy.\n\nUse 150–400ms micro-interactions and 500–900ms major transitions.\n\nRespect prefers-reduced-motion.\n\nKeep the entire site visually consistent with the Midnight Commerce color system."
