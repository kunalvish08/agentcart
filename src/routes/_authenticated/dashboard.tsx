...
function DashboardPage() {
  ...
  return (
    <AppShell
      ...
      subtitle="'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            REDESIGN THE CURRENT PUBLIC LANDING PAGE ONLY.\n\nThis is an implementation request. Do not display, copy, or add these instructions to the website.\n\nKeep all existing functionality, routes, links and backend logic unchanged.\n\nDESIGN GOAL\n\nTransform the landing page into a distinctive premium AI-commerce infrastructure product.\n\nIt should feel designed by an experienced product/UI designer:\n\ntechnical, elegant, confident, editorial and trustworthy.\n\nDo not make it look like a generic AI SaaS template.\n\nCOLOR SYSTEM\n\nReplace the current visual palette with:\n\nDeep Ink #0B1220\n\nMidnight #111B2E\n\nRoyal Cobalt #3157FF\n\nElectric Cyan #36C5D8\n\nCloud #F7F9FC\n\nSoft Ice #EAF2F7\n\nWhite #FFFFFF\n\nEmerald #18A878 for verified states\n\nAmber #D99020 for pending states\n\nCoral #D95C5C for errors\n\nUse cobalt for primary actions.\n\nUse cyan for AI/API concepts.\n\nUse emerald only for verified/completed states.\n\nAvoid purple gradients, neon colors, excessive glassmorphism and excessive shadows.\n\nTYPOGRAPHY\n\nUse a premium modern sans-serif.\n\nCreate strong editorial headlines, compact technical labels and clear body text.\n\nUse monospace only for API paths, system states and technical data.\n\nNAVIGATION\n\nKeep the existing navigation structure.\n\nMake it minimal and premium.\n\nAgentic Commerce should be visually dominant on the left.\n\nAgent API and Merchant Console should remain on the right.\n\nAdd subtle hover transitions.\n\nHERO\n\nReplace the current hero copy with:\n\nEyebrow:\n\nAI COMMERCE INFRASTRUCTURE\n\nHeadline:\n\nLet AI buyers shop your store.\n\nKeep the money under your control.\n\nSupporting text:\n\nExpose your catalog to external AI agents, let them discover products and negotiate within your rules — while pricing, checkout and payment remain server-authoritative.\n\nPrimary CTA:\n\nOpen Merchant Console\n\nSecondary CTA:\n\nExplore Agent API\n\nSmall trust line:\n\nServer-authoritative · Policy-bounded · Razorpay verified\n\nHERO VISUAL\n\nCreate a custom interactive infrastructure visualization instead of an illustration.\n\nShow:\n\nMERCHANT\n\nCatalog + Policies\n\n↓\n\nAI BUYER\n\n“Laptop under ₹60,000”\n\n↓\n\nPUBLIC AGENT API\n\n/search · /quote · /negotiate · /checkout\n\n↓\n\nSERVER AUTHORITY\n\nPrice · Inventory · Policy\n\n↓\n\nRAZORPAY\n\nVerified Payment\n\n↓\n\nCOMPLETED ORDER\n\nUse a dark Midnight visual panel with thin borders and cobalt/cyan accents.\n\nMake SERVER AUTHORITY the strongest visual node.\n\nAnimate a subtle data signal travelling through the flow.\n\nDo not use robots, stock images or generic AI graphics.\n\nCORE MESSAGE\n\nCreate a strong section with:\n\nAI decides what to ask.\n\nYour server decides what can happen.\n\nVisually compare:\n\nAI BUYER\n\nDiscover\n\nSearch\n\nQuote\n\nNegotiate\n\nRequest checkout\n\nversus:\n\nSERVER AUTHORITY\n\nPrice\n\nInventory\n\nDiscount limits\n\nOrder state\n\nPayment verification\n\nMake this distinction understandable at a glance.\n\nCAPABILITIES\n\nCreate three editorial sections rather than generic feature cards.\n\nDISCOVERABLE\n\nMake your catalog readable by machines.\n\nShow a small API interaction:\n\nGET /api/public/search\n\n→ DeveloperBook Pro 15\n\n→ ₹55,000\n\n→ in_stock\n\nBOUNDED\n\nLet agents negotiate without giving them pricing authority.\n\nShow:\n\nAI REQUEST\n\n30%\n\n→ SERVER POLICY\n\n12% CAP\n\n→ FINAL\n\n12%\n\nTRANSACTABLE\n\nTake the transaction all the way to verified payment.\n\nShow:\n\nQuote → Checkout → Razorpay → Verification → Completed\n\nAUTHORITY SECTION\n\nCreate a dark full-width section.\n\nHeadline:\n\nEvery money action has an authority.\n\nShow four connected stages:\n\nAI REQUESTS\n\n→ MERCHANT POLICY BOUNDS\n\n→ SERVER DECIDES\n\n→ RAZORPAY VERIFIES\n\nAdd concise supporting labels:\n\nNo client-side pricing\n\nNo AI-controlled discounts\n\nNo autonomous payment capture\n\nNo direct database access\n\nTRUST SECTION\n\nUse a compact technical strip containing:\n\nSERVER AUTHORITY\n\nPricing · Inventory · Policy\n\nTENANT ISOLATION\n\nMerchant-scoped data\n\nAUDITABLE\n\nOrders · Payments · Agent traces\n\nRAZORPAY\n\nTest-mode verified payments\n\nFINAL CTA\n\nCreate a strong dark closing section.\n\nEyebrow:\n\nBUILD FOR THE AGENTIC WEB\n\nHeadline:\n\nMake your store legible to AI.\n\nSupporting text:\n\nStart with your catalog. Define your commercial limits. Let external agents transact within them.\n\nButtons:\n\nOpen Merchant Console\n\nExplore Agent API\n\nShow:\n\nCATALOG → AGENT → POLICY → CHECKOUT → VERIFIED PAYMENT\n\nANIMATION\n\nUse Framer Motion.\n\nAdd:\n\n- staggered hero entrance\n\n- animated architecture flow\n\n- subtle moving signal between infrastructure nodes\n\n- server-authority pulse\n\n- button hover micro-interactions\n\n- scroll reveal for sections\n\n- API response reveal\n\n- animated 30% → 12% policy enforcement\n\n- payment verification transition into emerald success\n\n- sequential authority-node activation\n\nMotion must feel premium and purposeful.\n\nDo NOT use:\n\nbouncing elements\n\nfloating blobs\n\nrainbow effects\n\nexcessive particles\n\nlarge parallax effects\n\nconstant movement\n\ndecorative spinning elements\n\nUse smooth 150–300ms micro-interactions and 400–800ms major transitions.\n\nRESPONSIVE\n\nCreate a genuinely responsive layout.\n\nOn mobile, convert the architecture visualization into:\n\nAI BUYER\n\n↓\n\nPUBLIC API\n\n↓\n\nSERVER AUTHORITY\n\n↓\n\nRAZORPAY\n\n↓\n\nCOMPLETED\n\nDo not simply shrink the desktop design.\n\nFINAL QUALITY BAR\n\nThe landing page should communicate the product in 5 seconds:\n\nAI buyers can discover and transact with the merchant,\n\nbut the merchant's server controls money, policy and payment.\n\nMake the result premium, distinctive, technically credible and visually memorable.\n\nDo not change backend functionality or existing routes.\n\nDo not modify dashboard or any authenticated page."
