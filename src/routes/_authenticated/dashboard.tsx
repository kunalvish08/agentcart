...
function DashboardPage() {
  ...
  return (
    <AppShell
      ...
      subtitle="'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            Redesign the visual appearance of the current public landing page only.\n\nKeep all existing text, sections, links and functionality exactly as they are.\n\nDo not add new copy or new sections.\n\nGive the page a distinctive premium commerce-infrastructure identity.\n\nUse this color system:\n\nDeep Ink #0B1220\n\nMidnight #111B2E\n\nRoyal Cobalt #3157FF\n\nElectric Cyan #36C5D8\n\nCloud #F7F9FC\n\nWhite #FFFFFF\n\nEmerald #18A878 for verified states\n\nUse premium typography, strong editorial hierarchy, precise spacing, thin technical borders and asymmetric layouts.\n\nReduce generic rounded-card styling and avoid:\n\npurple gradients, rainbow colors, neon effects, excessive glassmorphism, floating blobs and stock/AI illustrations.\n\nMake the hero visually dominant.\n\nTurn the existing commerce flow into a refined technical architecture visual:\n\nMerchant → AI Buyer → Public API → Server Authority → Razorpay → Completed.\n\nMake Server Authority the strongest visual element.\n\nImprove the visual hierarchy of every existing section so the page feels like serious enterprise commerce infrastructure rather than a generic AI SaaS website.\n\nDo not change backend, database, API routes, authentication, Razorpay, evaluation logic or business logic.\n\nDo not display this instruction as website content."
